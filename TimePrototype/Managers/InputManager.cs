...
namespace TimePrototype.Managers
{
    public class InputManager : IUpdatableManager
    {
        ...
        private VirtualButton _returnTimeButton;
        public VirtualButton ReturnTimeButton => _returnTimeButton;

        private VirtualButton _timeSlowdownButton;
        public VirtualButton TimeSlowdownButton => _timeSlowdownButton;

        private VirtualButton _bushButton;
        public VirtualButton BushButton => _bushButton;
